...
function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-red-50/30 px-4 relative overflow-hidden">
      ...
      <div className="absolute top-20 right-20 w-72 h-72 bg-red-100 rounded-full blur-3xl opacity-30 blob-animate-1" />
      <div className="absolute bottom-20 left-20 w-96 h-96 bg-orange-100 rounded-full blur-3xl opacity-20 blob-animate-2" />
